...
class BaseaInsetImageSlotActions extends aSlotActions
{
  ...
  public function executeImage(sfRequest $request)
  {
    ...
    $this->logMessage("====== in aInsetImageSlotActions::executeImage", "info");
    $this->editSetup();
  ...
  {
    $this->logMessage("====== in aInsetImageSlotActions::executeEdit", "info");
    $this->editSetup();
